...
io.on('connection', function(socket) {
  socket.on('join_playlist_room', function(data) {
    console.log('joined room -> ' + data.room);
    return socket.join(data.room);
  });
  return socket.on('action_playlist', function(data) {
    console.log('action playlist');
    console.log(data.content);
    return socket.broadcast.to(data.room).emit('action_playlist', data.content);
  });
});
